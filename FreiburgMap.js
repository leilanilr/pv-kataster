...
document.addEventListener("DOMContentLoaded", function () {
  fetch("Freiburg.geojson")
    ...
    .then((data) => {
      ...
      var map = L.map("map").setView([47.999008, 7.842104], 12);
      ...
      legend.onAdd = function (map) {
        ...
        var ranges = [17000, 4000, 2000, 1000, 50, null];
        div.innerHTML = "<h4>Bruttoleistung der Einheit: <br /> kWp </h4>";
